  ...
  return (
    <section className="reveal px-6 py-14" ref={ref} style={bgStyle}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-8" style={{ gridTemplateColumns: `repeat(${testimonials.length || 1}, 1fr)` }}>
          {testimonials.map((t, i) => (
            <div key={i} className="flex flex-col items-center text-center gap-3">
              {/* Avatar */}
              {t.avatarUrl && (
                <div className="w-24 h-24 rounded-full overflow-hidden mx-auto" style={{ border: "4px solid #f5a100" }}>
